...
Для проведения симуляции я использовал Vivado. Но так же написал makefile для запуска симуляции в среде Modelsim. Для того что бы продемонстрировать работоспособность модуля прикрепляю скриншоты результата симуляции из Vivado.
...
Для проведения симуляции я использовал Vivado. Но так же добавил makefile для запуска симуляции в среде Modelsim. Для того что бы продемонстрировать работоспособность модуля прикрепляю скриншоты результата симуляции из Vivado.
